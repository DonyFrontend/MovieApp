import { IOn_the_air_serials } from '@/pages/home/model/types/SliceTypes';
...
type on_the_air = {
    data: IOn_the_air_serials,
    count: number,
    setCount: Dispatch<SetStateAction<number>>,
    heading: string,
}

const On_the_air: React.FC<on_the_air> = ({ count, data, heading, setCount }) => {
