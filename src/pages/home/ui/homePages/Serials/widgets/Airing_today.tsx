import { IAiring_today_serials } from '@/pages/home/model/types/SliceTypes'
...
type airing_today = {
    data: IAiring_today_serials,
    count: number,
    setCount: Dispatch<SetStateAction<number>>,
    heading: string,
}

const Airing_today: React.FC<airing_today> = ({ count, data, heading, setCount }) => {
